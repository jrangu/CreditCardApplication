...
class VisaCreditCardFactoryTest {

    @Test
    void getCreditCard() throws ParseException {

        CreditCardFactory creditCardFactory = new VisaCreditCardFactory();
        ...
        Assert.assertEquals(card.getType(), CreditCardType.CREDIT_CARD_TYPE_VISA);
    }
}
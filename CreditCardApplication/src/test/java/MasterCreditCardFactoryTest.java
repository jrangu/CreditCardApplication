...
class MasterCreditCardFactoryTest {

    @Test
    void getCreditCard() throws ParseException {
        CreditCardFactory creditCardFactory = new MasterCreditCardFactory();
        ...
        Assert.assertEquals(card.getType(), CreditCardType.CREDIT_CARD_TYPE_MASTER_CARD);
    }
}